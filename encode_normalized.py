...
"""
Encodes a given dataset with then Benji normalization step.
...
def encode_dataset(args):
    ...
    # Benji K-means clustering
    kmeans = joblib.load(Path("benji_checkpoints/kmeans_50.pt"))
